...
class YunTongxun extends Component
{
     ...
     * @return array|false 成功返回结果，失败返回false并记录日志
     */
    public function sendTemplateSMS(array $to, $datas, $tempId)
    {
        $toArr = implode(',', $to);
        $params = ['appId' => $this->appId, 'to' => $toArr, 'templateId' => $tempId, 'datas' => $datas];
