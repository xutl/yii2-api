...
class QIM extends BaseApi
{
    ...
    public function init()
    {
        ...
        if (!file_exists($privateKey) || !is_readable($privateKey)) {
            throw new InvalidConfigException ('The private key file does not exist or is unreadable.');
        }
        $this->privateKey = openssl_pkey_get_private(file_get_contents($privateKey));
